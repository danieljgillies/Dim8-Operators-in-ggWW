...
nnllnnlo_min=2*3000*array_for_plot(np.load("../Data/14TeV_HLLHC_veto/mWW_14TeV_veto35_sm_qq_nnllnnlo_qcd_min.npy"))
...
nlophoton_centre=2*3000*array_for_plot(np.load("../Data/14TeV_HLLHC_veto/mWW_14TeV_veto35_sm_gammagamma_nlo_centre.npy"))
nlophoton_min=2*3000*array_for_plot(np.load("../Data/14TeV_HLLHC_veto/mWW_14TeV_veto35_sm_gammagamma_nlo_min.npy"))
nlophoton_max=2*3000*array_for_plot(np.load("../Data/14TeV_HLLHC_veto/mWW_14TeV_veto35_sm_gammagamma_nlo_max.npy"))

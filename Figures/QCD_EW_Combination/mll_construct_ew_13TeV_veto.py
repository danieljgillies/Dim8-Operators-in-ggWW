...
nnllnnlo_centre=np.load("../Data_numpy_for_figures/13TeV_ATLAS/mll_13TeV_veto35_sm_qq_nnllnnlo_qcd_centre.npy")
nnllnnlo_min=np.load("../Data_numpy_for_figures/13TeV_ATLAS/mll_13TeV_veto35_sm_qq_nnllnnlo_qcd_min.npy")
nnllnnlo_max=np.load("../Data_numpy_for_figures/13TeV_ATLAS/mll_13TeV_veto35_sm_qq_nnllnnlo_qcd_max.npy")
nloew_centre=np.load("../Data_numpy_for_figures/13TeV_ATLAS/mll_13TeV_veto35_sm_qq_nlo_ew_centre.npy")
lo_centre=np.load("../Data_numpy_for_figures/13TeV_ATLAS/mll_13TeV_veto35_sm_qq_lo_centre.npy")
